...
previousyear = dt.datetime.strftime(previousyear, '%Y-%m-%d')
...
@app.route("/")
def home():
    return (f"Hawaii Climate API<br/>"
            f"Available Routes:<br/>"
            f"/api/v1.0/stations<br/>"
            f"/api/v1.0/precipitaton<br/>"
            f"/api/v1.0/temperature<br/>"
            f"datesearch (yyyy-mm-dd)<br/>"
            f"/api/v1.0/datesearch/yyyy-mm-dd<br/>"
            f"/api/v1.0/datesearch/yyyy-mm-dd/yyyy-mm-dd<br/>"
            f"dates from 2010-01-01 to 2017-08-23<br/>"
            )
